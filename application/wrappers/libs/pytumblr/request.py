...
from application.core.apiwrappers.libs import oauth2 as oauth
from application.core.apiwrappers.libs.httplib2 import RedirectLimit
...
class TumblrRequest(object):
    ...
    def post_multipart(self, url, params, files):
        ...
        r = urllib.Request(url, bytearray(body), headers)
        content = urllib.urlopen(r).read()
        return self.json_parse(content)
